...
import AdminCreateSchedule from "./components/Admin/Schedule/CreateSchedule";
import AdminDoctorSchedule from "./components/Admin/Schedule/DoctorsSchedule";
    ...
    */}
      ...
      <main>
        <Routes>
          ...
          <Route exact path="/admin/schedule" element={< AdminDoctorSchedule />} />
          <Route exact path="/admin/schedule/create" element={< AdminCreateSchedule />} />
